...
const contactInfo = [];
graduates.forEach(items => contactInfo.push(`${items.first_name} ${items.email}`))
console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
let unisWithUni = graduates.filter(currentValue => currentValue.university.includes('Uni'));
...
*/
const displayNames = [];
zooAnimals.forEach((items) => displayNames.push(`${items.animal_name}  ${items.scientific_name}`))
